...
<main>
    ...
    <div class="wrapper">
      <div class="cons-dir-cerc">
        <a href="#" id="r1">Președinte</a>
        <a href="#" id="r2">Prim<br>Vicepreședinte</a>
        <a href="#" id="r3">Vicepreședinte<br>Externe</a>
        <a href="#" id="r4">Vicepreședinte<br>Educational</a>
        <a href="#" id="r5">Vicepreședinte<br>Proiecte</a>
        ...
        <a href="#" id="r10">Vicepreședinte<br><span>Zona Vest</span></a>
        <a href="#" id="r11">Vicepreședinte<br><span>Zona Centru-Nord</span></a>
        <a href="#" id="r12">Vicepreședinte<br><span>Zona Est</span></a>
        <a href="#" id="r13">Vicepreședinte<br><span>Zona Sud-Vest</span></a>
        <a href="#" id="r14">Vicepreședinte<br><span>Zona Sud-Est</span></a>
    ...
    <ul class="cons-dir-list">
      ...
      <li>
        ...
        <div class="wrapper">
          <p class="functie">Prim Vicepreședinte</p>
      ...
      <li>
        ...
        <div class="wrapper">
          <p class="functie">Vicepreședinte Externe</p>
      ...
      <li>
        ...
        <div class="wrapper">
          <p class="functie">Vicepreședinte Educațional</p>
      ...
      <li>
        ...
        <div class="wrapper">
          <p class="functie">Vicepreședinte Proiecte</p>
      ...
      <li>
        ...
        <div class="wrapper">
          <p class="functie">Vicepreședinte<br>Zona Vest</p>
      ...
      <li>
        ...
        <div class="wrapper">
          <p class="functie">Vicepreședinte<br>Zona Centru-Nord</p>
      ...
      <li>
        ...
        <div class="wrapper">
          <p class="functie">Vicepreședinte<br>Zona Est</p>
      ...
      <li>
        ...
        <div class="wrapper">
          <p class="functie">Vicepreședinte<br>Zona Sud-Vest</p>
      ...
      <li>
        ...
        <div class="wrapper">
          <p class="functie">Vicepreședinte<br>Zona Sud-Est</p>
